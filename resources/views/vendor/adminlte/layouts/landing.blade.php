...
<div id="app" v-cloak>
        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        <h1> My ToDo list</h1>
                        <h3>You don’t overlook so many tasks and forget anything .You feel more organized .It helps you with planning.</h3>
    ...
    <footer>
        <div id="c">
            <div class="container">
                <p>
                    <a href="#"></a><b>TODo List Check Created by Mahfuz</b></a>
                </p>
